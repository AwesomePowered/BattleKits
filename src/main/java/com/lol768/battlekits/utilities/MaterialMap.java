...
public class MaterialMap {
    ...
    public static String getFromLegacyId(String id) {
        switch (BattleKits.legacyType) {
            case "v1_13_":
                return getById(id).getFlatteningType();
            default:
                return getById(id).getLegacyType();
        }
    }

    public static String getFromLegacyType(String type) {
        switch (BattleKits.legacyType) {
            case "v1_13_":
                return getByLegacyType(type).getFlatteningType();
            default:
                return getByLegacyType(type).getLegacyType();
        }
    }
